...
const ProductCard = ({ product }) => {
    ...
    const { currency, removeFromCart, cartitems, addToCart, navigate } = useAppContext(); // Ensure addToCart is available in your context
                    ...
                    <div onClick={(e)=>{e.stopPropagation();}} className="text-primary">
                        {!cartitems[product._id] ? (
                            <button 
                                ...
                                onClick={() => addToCart(product._id)} // Add to cart logic
                            >
                            ...
                            <div className="flex items-center justify-center gap-2 md:w-20 w-16 h-[34px] bg-primary/25 rounded select-none">
                                <button 
                                    onClick={() => {removeFromCart(product._id)}} // Remove from cart logic
                                ...
                                <button 
                                    onClick={() => {addToCart(product._id)}} // Add more logic
                                    className="cursor-pointer text-md px-2 h-full"
                                >
                                    +
                                </button>
