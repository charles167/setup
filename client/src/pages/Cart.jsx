...
const Cart = () => {
    ...
    const placeOrder = async () => {
        // Add logic for placing the order (e.g., API call)
    };
    ...
    // Check if Products or cartItems are empty and return null until they are available
    if (!Products || Products.length === 0 || !cartItems) {
    ...
    return (
        <div className="flex flex-col md:flex-row mt-16">
            <div className="flex-1 max-w-4xl">
                ...
                {/* Check if cartArray is defined and has items */}
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                {address.map((address, index) => (
                                    <p onClick={() => { setSelectedAddress(address); setShowAddress(false); }} className="text-gray-500 p-2 hover:bg-gray-100" key={index}>
